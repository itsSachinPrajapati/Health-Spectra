...
export default function VoiceBotCard() {
  const navigate = useNavigate();

  return (
    <div
      onClick={() => navigate("/dashboard/tools/voicebot")}
    ...
    >
      <div>
        ...
        <h2 className="text-2xl font-semibold mb-2 text-gray-800">Voice Assistant</h2>
        <p className="text-gray-500">Interact with our AI voice bot for assistance.</p>
      </div>
